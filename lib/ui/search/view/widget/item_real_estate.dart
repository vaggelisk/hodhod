              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    //               //     "${controller.data.value.countryCode ?? ""}${controller.data.value.phoneNumber ?? ""}");
                    //             },
                    //             child: SvgPicture.asset(
                        ...
                        child: InkWell(
                            onTap: () {
                              if (Get.find<SearchPageController>()
                                  .storage
                                  .isAuth()) {
                                Get.find<SearchPageController>().launchWhatsApp(
                                    data.user?.mobile ?? "", data.id ?? 0);
                              } else {
                                confirmBottomSheet();
                              }
                        ...
                        child: InkWell(
                            onTap: () {
                              if (Get.find<SearchPageController>()
                                  .storage
                                  .isAuth()) {
                                Get.find<SearchPageController>().makePhoneCall(
                                    data.user?.mobile ?? "", data.id ?? 0);
                              } else {
                                confirmBottomSheet();
                              }
