...
import 'package:hodhod/ui/add_real_estate/view/widget/item_add_parent_featured.dart';
import 'package:hodhod/ui/search_filter/controller/search_filter_controller.dart';


class PropertyFeaturesSearch extends StatelessWidget {
  PropertyFeaturesSearch({super.key});

  SearchFilterController controller = Get.find<SearchFilterController>();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomAppBar(
          title: Text(LangKeys.propertyFeatures.tr,
